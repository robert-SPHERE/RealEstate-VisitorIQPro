...
(async () => {
  ...
  server.listen({
    ...
    log(`Scheduled sync services started - SpherePixel and Handwrytten: hourly 8AM-8PM Central Time, Mailchimp: 12AM Central Time`);
    ...
    try {
      ...
      monitor.start();
      log(`Database connection monitoring started`);
    } catch (error) {
